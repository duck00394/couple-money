  ...
  return (
    <>
      ...
      <div className="space-y-4 px-4">
        ...
        <Card className="p-0">
          <p className="border-b border-stone-100 px-4 py-3 text-sm font-semibold">已經產生的記帳（{r.transactions.length}）</p>
          {r.transactions.length === 0 ? (
            <p className="p-4 text-center text-sm text-stone-500">還沒有產生過記帳</p>
          ) : (
            <ul className="divide-y divide-stone-100" data-testid="recurring-history">
      ...
      <Collapsible title="✏️ 修改設定" className="mx-4">
        <RecurringForm

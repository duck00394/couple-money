                      ...
                      <div className="shrink-0 text-right">
                        {isCard ? (
                          <>
                            ...
                            <p className={`tnum font-semibold ${a.balance < 0 ? "text-orange-600" : "text-stone-800"}`}>{formatMoney(Math.abs(a.balance))}</p>
                          </>
                        ) : (
                          <>
                            {fundPart !== 0 && <p className="text-[11px] text-stone-500">實際餘額</p>}
                            <p className={`tnum font-semibold ${a.balance < 0 ? "text-orange-600" : "text-stone-800"}`}>{formatMoney(a.balance)}</p>
                          </>
                        )}
                      </div>
                    </div>

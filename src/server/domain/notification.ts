...
export const NOTIFIABLE: Record<string, { icon: string; text: string }> = {
  // 記帳
  "Transaction:CREATE": { icon: "🧾", text: "新增了一筆" },
  "Transaction:UPDATE": { icon: "✏️", text: "修改了一筆" },
  "Transaction:DELETE": { icon: "🗑️", text: "作廢了一筆" },
  // 帳戶
  "Account:CREATE": { icon: "💳", text: "新增了帳戶" },
  "Account:ADJUST": { icon: "📒", text: "調整了帳戶餘額" },
  // 收據
  "Attachment:CREATE": { icon: "📎", text: "加了一張收據" },
  "Attachment:DELETE": { icon: "📎", text: "刪掉了一張收據" },
  // 結算
  "Settlement:CREATE": { icon: "🤝", text: "結算了" },
  "Settlement:DELETE": { icon: "↩️", text: "取消了一筆結算" },
  // 任務與打卡
  "CheckIn:CREATE": { icon: "✅", text: "完成了打卡" },
  "CheckIn:UPDATE": { icon: "✏️", text: "修改了打卡" },
  "CheckIn:CANCEL": { icon: "↩️", text: "取消了打卡" },
  "CheckIn:APPROVE": { icon: "👍", text: "確認了打卡" },
  "CheckIn:REJECT": { icon: "👎", text: "退回了打卡" },
  "Task:CREATE": { icon: "📌", text: "新增了任務" },
  "Task:UPDATE": { icon: "✏️", text: "修改了任務" },
  "Task:DELETE": { icon: "🗑️", text: "刪除了任務" },
  "TaskPenalty:WAIVE": { icon: "🙏", text: "免除了一次懲罰" },
  // 基金與目標
  "Fund:CREATE": { icon: "🐷", text: "新增了基金" },
  "Fund:UPDATE": { icon: "✏️", text: "修改了基金" },
  "Fund:DELETE": { icon: "🗑️", text: "刪除了基金" },
  "Fund:REQUEST_DELETE": { icon: "❓", text: "想刪除基金" },
  "Fund:DELETE_REJECTED": { icon: "🙅", text: "拒絕刪除基金" },
  "FundTransaction:CREATE": { icon: "🐷", text: "動了基金的錢" },
  "FundTransaction:DELETE": { icon: "↩️", text: "作廢了一筆基金紀錄" },
  "FundTransaction:CANCEL": { icon: "↩️", text: "取消了獎金入金" },
  "FundTransaction:REWARD_DEPOSIT": { icon: "💰", text: "把任務獎金入金了" },
  "Goal:CREATE": { icon: "🎯", text: "新增了目標" },
  "Goal:UPDATE": { icon: "✏️", text: "修改了目標" },
  "Goal:DELETE": { icon: "🗑️", text: "刪除了目標" },
  "Goal:REQUEST_DELETE": { icon: "❓", text: "想刪除目標" },
  "Goal:DELETE_REJECTED": { icon: "🙅", text: "拒絕刪除目標" },
  // 固定支出
  "RecurringExpense:CREATE": { icon: "📅", text: "新增了固定支出" },
  "RecurringExpense:UPDATE": { icon: "✏️", text: "修改了固定支出" },
  "RecurringExpense:PAUSE": { icon: "⏸️", text: "停用了固定支出" },
  "RecurringExpense:RESUME": { icon: "▶️", text: "重新啟用了固定支出" },
  "RecurringExpense:DELETE": { icon: "🗑️", text: "刪除了固定支出" },
  // 分類
  "Category:CREATE": { icon: "🏷️", text: "新增了分類" },
  "Category:UPDATE": { icon: "✏️", text: "改了分類名稱" },
  "Category:ARCHIVE": { icon: "🚫", text: "停用了分類" },
  "Category:RESTORE": { icon: "♻️", text: "重新啟用了分類" },
  "Category:DELETE": { icon: "🗑️", text: "刪除了分類" },
  // 預算
  "Budget:CREATE": { icon: "🎯", text: "設了預算" },
  "Budget:UPDATE": { icon: "✏️", text: "改了預算" },
  "Budget:ARCHIVE": { icon: "🚫", text: "停用了預算" },
  "Budget:RESTORE": { icon: "♻️", text: "重新啟用了預算" },
  "Budget:DELETE": { icon: "🗑️", text: "刪掉了預算" },
  // 帳本
  "BookMember:JOIN": { icon: "💞", text: "加入了帳本" },
};

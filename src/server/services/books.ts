...
export interface BookContext {
  ...
  me: { userId: string; nickname: string; role: string; avatarColor: string };
  members: Array<{ userId: string; nickname: string; role: string; avatarColor: string }>;
  partner: { userId: string; nickname: string; role: string; avatarColor: string } | null;
  canWrite: boolean;
}
